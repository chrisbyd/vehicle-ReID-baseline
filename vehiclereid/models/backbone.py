...
class ResNet(nn.Module):
    ...
    def __init__(self, num_classes, loss, block, layers,
        ...
        self.hash_bit_number = kwargs['hash_bit']
        # backbone network
        ...
        self.hash_layer = nn.Linear(self.feature_dim, self.hash_bit_number)
        self.classifier = nn.Linear(self.hash_bit_number, num_classes)
        self._init_params()
